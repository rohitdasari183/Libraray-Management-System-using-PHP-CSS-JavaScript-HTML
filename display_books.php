...
?>
<!DOCTYPE html>
<!-- saved from url=(0043)http://localhost/LibraryManagement/par4.php -->
<html lang="zxx" class=" js no-touch js no-touch js no-touch js no-touch" style="overflow: hidden;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<!-- //custom-theme -->
<link href="./par4_files/bootstrap.css" rel="stylesheet" type="text/css" media="all">
<link href="./par4_files/component.css" rel="stylesheet" type="text/css" media="all">
<link href="./par4_files/style_grid.css" rel="stylesheet" type="text/css" media="all">
<link href="./par4_files/style.css" rel="stylesheet" type="text/css" media="all">
<!-- font-awesome-icons -->
<link href="./par4_files/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome-icons -->
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
			  		 <!-- /nav_agile_w3l -->
				<li class="gn-trigger">
					<a class="gn-icon gn-icon-menu gn-selected"><i class="fa fa-bars" aria-hidden="true"></i><span>Menu</span></a>
					<nav class="gn-menu-wrapper gn-open-all">
						<div class="gn-scroller scrollbar1" tabindex="5000" style="overflow: hidden; outline: none;">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="http://localhost/LibraryManagement/studentregistration.php"><i class="fa fa-cogs" aria-hidden="true"></i>Student Information</a> 
									
								</li>
								<li>
									<a href="http://localhost/LibraryManagement/studentlogin.php"><i class="fa fa-cogs" aria-hidden="true"></i>Student Login</a> 
							...
							<!--/forms-->
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Issued Books Details </h3>
																	<div class="form-body">
																																		
		

																	<?php 
    $qry=mysqli_query($DBcon,"SELECT * FROM library.books");
...
while($row = mysqli_fetch_array($qry))
{
   ...
   ?><tr>
        ...
        <td><?php echo $row['b_image'];?></td>
        <td><?php echo $row['b_author_name'];?></td>
       
        <td><?php echo $row['b_publication_name'];?></td>
        <td><?php echo $row['b_purchase_date'];?></td>
        <td><?php echo $row['b_price'];?></td>
        <td><?php echo $row['b_quantity'];?></td>
        <td><?php echo $row['b_available_quantity'];?></td>
        <td><?php echo $row['b_lib_issued'];?></td>
...
<!-- js -->
          ...
          <script type="text/javascript" src="./par4_files/jquery-2.1.4.min.js.download"></script>
		  <script src="./par4_files/modernizr.custom.js.download"></script>
		
		   <script src="./par4_files/classie.js.download"></script>
		  <script src="./par4_files/gnmenu.js.download"></script>
		  <script>
			new gnMenu( document.getElementById( 'gn-menu' ) );
		 </script>

<!-- //js -->
<script src="./par4_files/screenfull.js.download"></script>
		<script>
		$(function () {
