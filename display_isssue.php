					...
					<nav class="gn-menu-wrapper gn-open-all">
						<div class="gn-scroller scrollbar1" tabindex="5000" style="overflow: hidden; outline: none;">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="http://localhost/LibraryManagement/display_books.php"><i class="fa fa-cogs" aria-hidden="true"></i>Display Available Books</a> 
									
								</li>
							
								<li><a href="http://localhost/LibraryManagement/par4.php"> <i class="fa fa-table" aria-hidden="true"></i>Logout</a></li>
													...
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Issued Books Details </h3>
																	...
																	<?php 
    $qry=mysqli_query($DBcon,"SELECT * FROM library.issue_books");
...
while($row = mysqli_fetch_array($qry))
{
   ...
   ?><tr>
        ...
        <td><?php echo $row['booktaken'];?></td>
        <td><?php echo $row['fee'];?></td>
        <td><?php echo $row['enrollment'];?></td>
       
        <td><?php echo $row['bookissuedate'];?></td>
        <td><?php echo $row['bookreturndate'];?></td>
